...
# print(Counter(pred_svc_poly)) # Output: 0.97543
...
# print(Counter(pred_rfc_500)) # Output: 0.96671
...
# print(Counter(pred_rfc_1000)) # Output: 0.96729
...
# print(Counter(pred_pca_25)) # Output: 0.90614
...
# print(Counter(pred_pca_50)) # Output: 0.92500
...
# print(Counter(pred_pca_100)) # Output: 0.93871

pca_100 = PCA(n_components=100, whiten=True)
pca_100.fit(train_data)
train_data_100 = pca_100.transform(train_data)
clf_pca_100v2 = svm.SVC()
clf_pca_100v2.fit(train_data_100, train_target)
test_100 = pca_100.transform(test)
pred_pca_100v2 = clf_pca_100v2.predict(test_100)
print(Counter(pred_pca_100v2)) # Output: 0.97600
...
# print(Counter(pred_pca_200)) # Output: 0.94743
...
np.savetxt("submission_pca_100v2.csv", np.c_[range(1, len(test) + 1), pred_pca_100v2], delimiter=",", header="ImageId,Label", comments="", fmt="%d")
